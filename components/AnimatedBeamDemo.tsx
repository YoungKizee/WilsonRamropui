...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-10 md:size-12 items-center justify-center p-2 md:p-2.5 [&>svg]:w-full [&>svg]:h-full",
        className
      )}
    >
      {children}
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[300px] md:h-[500px] w-full items-center justify-center overflow-hidden p-4 md:p-10",
        className
      )}
      ref={containerRef}
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-4 md:gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-14 md:size-16 p-3 md:p-4">
            <Icons.openai />
          </Circle>
        </div>
